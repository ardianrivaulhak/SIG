...
export class FormatTekananDifferentialEnService {
  ...
  async generatePdf(sample, check){
    ...
    var rows = await [];
    await rows.push([
        {text : 'Test Area', rowSpan: 2},
        {text : 'ΔP (Pa/cm²)',colSpan: 5},
        {},
        {},
        {},
        {},
    ...
    await rows.push([
        {text : 'Requirement', rowSpan: 3},
        {text : 'Type I'},
        {text : '< 40 (Pa/cm²)', colSpan : 4},
        {},
        {},
        {},
      ...
      content: 
          ...
          },      
        {
            ...
            table: {
              widths: [250, 5, "*", "*"],
              body: [
                  [{text: 'Sample Information', bold: true}, {}, {}, {}],
                  [{text:'Sample Name'}, {text: ':'}, {text: sample.sample_name == null ? '-' :  sample.sample_name}, {}],
                  [{text:'Marketing Number'}, {text: ':'}, {text: sample.transaction_sample.kontrakuji.contract_no}, {}],
                  [{text:'Batch/Lot Number'}, {text: ':'}, {text: sample.batch_number == null ? '-' :  sample.batch_number + '/' + sample.lot_number == null ? '-' :  sample.lot_number}, {}],
                  [{text:'Method'}, {text: ':'}, {text: sample.parameters[0].metode}, {}],
                  [{text:'Date Received'}, {text: ':'}, {text:  sample.tgl_input == null ? '-' :  moment(sample.tgl_input).format("DD MMMM YYYY")}, {}],
                  [{text:'Date Tested'}, {text: ':'}, {text: `${moment(sample.tgl_mulai).format("DD MMMM YYYY")} - ${moment(sample.tgl_selesai).format("DD MMMM YYYY")}`}, {}],
                  [{text:''}, {text: ''}, {text: ''}, {}],
                  [{text:''}, {text: ''}, {text: ''}, {}],
                  [{text: 'Test Information', bold: true}, {}, {}, {}],
                  [{text:'Flow Rate', italic: true}, {text: ':'}, {text: '8L/min'}, {}]
              ]
            }
        },
        tableParameter,
