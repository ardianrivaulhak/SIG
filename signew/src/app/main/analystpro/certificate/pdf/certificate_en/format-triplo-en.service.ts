...
export class FormatTriploEnService {
  pdfMake: any;
  ...
  async generatePdf(sample, check){
    ...
    let tableParameter = await {
      ...
      table: {
        widths: [15, 100, 50, 50, 50, 50, 50, 75],
          body: rows,
          dontBreakRows: true,
      },
      alignment: "center",
              ...
              stack: [
                  {
                      columns: [
                          ...
                          {
                            text:
                              `Bogor, ${moment(sample.condition_cert[0].date_at ).format("MMMM DD, YYYY")}`,
                            alignment: "right",
                  ...
                  columns: [
                    sample.condition_cert[sample.condition_cert.length - 1].status != 3 ? 
                    {
                      ...
                      table: {
                          ...
                          width: 500,
                          body: [
                              [{text:  `Bogor, ${moment(sample.condition_cert[0].date_at ).format("MMMM DD, YYYY")}`, }],
                              [{text: `PT. Saraswanti Indo Genetech`}],
                              [{
                                image: image.dwi,
                                width: 150,
