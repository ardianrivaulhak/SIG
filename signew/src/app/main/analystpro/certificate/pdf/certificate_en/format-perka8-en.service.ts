...
export class FormatPerka8EnService {
  pdfMake: any;
    ...
    var def = {
      ...
      content: 
        ...
        tableParameter,
        {
            ...
            table : {
                body: [
                    [{text: `n`}, {text: `=`}, {text: `Amount of samples`}],                    
                    [{text: `m, M`}, {text: `=`}, {text: `Limit of microbial/bacteria`}],
                    [{text: `c`}, {text: `=`}, {text: `Tolerable value above the standard of microbe limit to determine the acceptance of food product
                    According to Regulation of National Agency Food and Drugs Control Republic of Indonesia No 08, 2016`}],
                    [{text:''},{text:''},{text: ``}],
                    [{text:''},{text:''},{text: ``}],
                ],
            }
