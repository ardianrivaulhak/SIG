...
export class FormatNormalManualEnService {
  pdfMake: any;
          ...
          },
        {
          ...
          table: {
            ...
            body: [
                ...
                [{}, {text:'3.13. Date of Acceptance / Diterima '}, ':', sample.tgl_input == null ? '-' :  moment(sample.tgl_input).format("MMMM DD, YYYY")  ],
                [{}, {text:'3.14. Date of Analysis / Tanggal Uji'}, ':', `${moment(sample.tgl_mulai).format("MMMM DD, YYYY")} - ${moment(sample.tgl_selesai).format("MMMM DD, YYYY")}`],
                [{}, {text:'3.15. Type of Analysis / Jenis Uji '}, ':', 'Enclosed'],
