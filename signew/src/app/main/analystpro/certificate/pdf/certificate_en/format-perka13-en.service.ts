...
export class FormatPerka13EnService {
  pdfMake: any;
        ...
        tableParameter,
        {
            ...
            table : {
                body: [
                    ...
                    [{text: `c`}, {text: `=`}, {text: `The amount that may exceed the microbial limit to determine the acceptability of a food product`}],
                    [{text:''},{text:''},{text: ``}],
                    [{text:''},{text:''},{text: ``}],
                    [{text:''},{text:''},{text: `In accordance with the Regulation of the Head of the Indonesian Food and Drug Supervisory Agency No. 13 of 2019.`}],
                ],
            }
        },
        {
