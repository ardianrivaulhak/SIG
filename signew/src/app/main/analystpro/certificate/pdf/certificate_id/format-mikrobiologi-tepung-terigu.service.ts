...
export class formatMikroTepungTeriguService {
    ...
    var def = {
      ...
      content: 
        ...
        tableParameter,
        {
          ...
          table : {
              body: [
                  [{text: `n`}, {text: `=`}, {text: `Jumlah contoh yang diambil dan dianalisis`}],
                  [{text: `c`}, {text: `=`}, {text: `Jumlah maksimum contoh yang boleh melampaui batas mikroba untuk menentukan keberterimaan suatu produk pangan`}],
                  [{text: `m,M`}, {text: `=`}, {text: `Batas mikroba`}],
                  [{text: `NA`}, {text: `=`}, {text: `Not applicable`, italics: true}],
                  [{text:''},{text:''},{text: ``}],
                  [{text:''},{text:''},{text: ``}],
                  [{text:''},{text:''},{text: `Sesuai SNI 3751:2018 Tepung Terigu sebagai Bahan Makanan.`}],
              ],
          }
      },
        {
