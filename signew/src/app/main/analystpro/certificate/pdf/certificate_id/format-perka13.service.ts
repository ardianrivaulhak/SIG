...
export class FormatPerka13Service {
  ...
  async generatePdf(sample, check){
    ...
    let tableParameter = await {
      ...
      table: {
        widths: [15, 130, 15, 15, 75, 30, 25, 25, 75],
          body: rows,
    ...
    var def = {
      ...
      content: 
        ...
        tableParameter,
        {
            ...
            table : {
                body: [
                    [{text: `n`}, {text: `=`}, {text: `Jumlah sampel yang diambil dan dianalisis`}],
                    [{text: `m, M`}, {text: `=`}, {text: `Batas mikroba`}],
                    [{text: `c`}, {text: `=`}, {text: `Jumlah yang boleh melampaui batas mikroba untuk menentukan keberterimaan suatu produk pangan`}],
                    [{text:''},{text:''},{text: ``}],
                    [{text:''},{text:''},{text: ``}],
                    [{text:''},{text:''},{text: `Sesuai Peraturan Kepala Badan Pengawas Obat dan Makanan RI No 13 Tahun 2019.`}],
                ],
            }
        },
        {
