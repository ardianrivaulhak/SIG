...
export class FormatNormalManualService {
  ...
  let html = htmlToPdfmake(`${sample.manual.datamanual}`);
  let ret = htmlToPdfmake(`<img src="https://picsum.photos/seed/picsum/200">`, {
          ...
          },
        {
          ...
          table: {
            ...
            body: [
                ...
                [{}, {text:'3.12. Date of Sampling / Tanggal Sampling'}, ':', sample.tgl_sampling == null ? '-' :  sample.tgl_sampling],
                [{}, {text:'3.13. Date of Acceptance / Diterima '}, ':', sample.tgl_input == null ? '-' :  moment(sample.tgl_input).format("DD MMMM YYYY")  ],
                [{}, {text:'3.14. Date of Analysis / Tanggal Uji'}, ':', `${moment(sample.tgl_mulai).format("DD MMMM YYYY")} - ${moment(sample.tgl_selesai).format("DD MMMM YYYY")}`],
                [{}, {text:'3.15. Type of Analysis / Jenis Uji '}, ':', 'Terlampir'],
