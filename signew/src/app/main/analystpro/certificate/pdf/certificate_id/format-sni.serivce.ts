...
export class FormatSNIService {
  ...
  async generatePdf(sample, check){
    ...
    let tableParameter = await {
      ...
      table: {
        widths: [15, 150, 15, 15, 50, 25, 25, 20, 100],
          body: rows,
          ...
          },
        {
          ...
          table: {
            ...
            body: [
                ...
                [{}, {text:'3.14. Date of Analysis / Tanggal Uj'}, ':', `${moment(sample.tgl_mulai).format("DD MMMM YYYY")} - ${moment(sample.tgl_selesai).format("DD MMMM YYYY")}`],
                    ...
                    sample.condition_cert[sample.condition_cert.length - 1].status != 3 ? 
                    {
                      ...
                      },
                      {
                          ...
                          table: {
                              ...
                              body: [
                                  [
                                    {qr: 'http://siglabnew.online/#/certificate/pdf-certificate/' + sample.id + '/id', fit:'75'}
                                  ],
                              ],
                          },
                      },
