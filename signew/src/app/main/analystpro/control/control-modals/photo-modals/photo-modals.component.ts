...
@Component({
  selector: 'app-photo-modals',
  templateUrl: './photo-modals.component.html',
  styleUrls: ['./photo-modals.component.scss'],
  animations   : [
    trigger('slider', [
...
export class PhotoModalsComponent implements OnInit {
  ...
  photoForm: FormGroup;
  constructor(
    public dialogRef: MatDialogRef<PhotoModalsComponent>,
  ...
  getData(){
    ...
    this._controlService.getDataPhotoSample(this.datasent)
