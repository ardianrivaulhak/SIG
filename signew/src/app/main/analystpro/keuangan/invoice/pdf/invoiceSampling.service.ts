...
export class InvoiceSamplingFormService {
         ...
         rows.push([
            {
               ...
               {
                border: [false,false,false, false],
                text: `${x.samplingmaster.sampling_name}`,
                nowarp: true,
                alignment: 'justify',
               },
               {
                border: [false,false,false, false],
                alignment: 'right',
                text: `${x.samplingmaster.price.toLocaleString()}`
               },
               {
                border: [false,false,false,false],
                alignment: 'center',
                                ...
                                }, 
                                {
                                  ...
                                  table: {
                                    ...
                                    body: [
                                            ...
                                            [{ text: 'Sub Total :', alignment: "right"}, {text: `Rp. ${data.priceSubtotal.toLocaleString()}`, alignment: "right"}],
                                            [{ text: 'Diskon :', alignment: "right"}, {text: `Rp. ${data.discount.toLocaleString()}`, alignment: "right"}],
                                            ...
                                            [{ text: 'TOTAL:', alignment: "right"},
                                             {text: `Rp. ${(data.total).toLocaleString()}`,
                                              alignment: "right"}],
