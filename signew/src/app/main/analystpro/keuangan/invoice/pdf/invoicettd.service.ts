...
export class InvoiceFormTtdService {
    ...
    // console.log();
      ...
      for(let i = 0; i < page; i++){
        ...
        tableParameter = tableParameter.concat(
          ...
          i == (page - 1) ? {} : { text:'', fontSize: 14, bold: true, pageBreak: 'before', margin: [0, 0, 0, 8] }
        )
      }
                                ...
                                [
                                  {
                                    ...
                                    table: {
                                        ...
                                        body: [
                                                ...
                                                [{ text: 'Faks /  Fax'}, ':', `${data.fax == null ? '-' : data.fax}`],
                                                ]
                                        }
                                   },
                                ]
                                ...
                                }, 
                                {
                                  ...
                                  table: {
                                    ...
                                    body: [
                                            ...
                                            [{ text: 'TOTAL:', alignment: "right"}, {text: `Rp. ${data.totalcostsample.toLocaleString()}`, alignment: "right"}],
      ...
      data.printed == 'N' ? await this.pdfMake.createPdf(def).open() : await this.pdfMake.createPdf(def).print()
