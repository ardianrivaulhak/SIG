    ...
    <!-- end cover container -->
       ...
       <!-- end header footer LHU-->
        ...
        <div class="container">
            ...
            <!-- Next page -->        
            <div class="pages" style="page-break-after: never; margin-bottom: 100px;">
                <div class="lhu">
                    <div class="row-3-parent">
                        <div class="head-result" style="padding-top:10px; text-align: center;">
                            <h4>RESULT OF ANALYSIS / LEMBAR HASIL UJI </h4>
                        ...
                        <div style="margin-bottom: 50px;">
                            <table>
                               <tr>
                                <td width="30px">3. 11</td>
                                <td width="300px">Other Information / Keterangan lain</td>
                                <td width="2px">: </td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td>3.11.1. No Notifikasi</td>
                                <td>: </td>
                                <td>{{ $sertifikat['no_notifikasi'] == null ? '-' : $sertifikat['no_notifikasi'] }} </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>3.11.2. No Pengajuan</td>
                                <td>: </td>
                                <td>{{$sertifikat['no_pengajuan'] == null ? '-' : $sertifikat['no_pengajuan'] }} </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>3.11.3. No Registrasi</td>
                                <td>: </td>
                                <td>{{$sertifikat['no_registrasi'] == null ? '-' : $sertifikat['no_registrasi'] }} </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>3.11.4. No Principal Code</td>
                                <td>: </td>
                                <td>{{$sertifikat['no_principalcode'] == null ? '-' : $sertifikat['no_principalcode'] }}</td>
                            </tr>
                            <tr>
                                <td>3.12.</td>
                                <td>Date of Received / Diterima</td>
                                <td>: </td>
                                <td>{{$sertifikat['tgl_mulai'] == null ? '-' : date('d F Y', strtotime($sertifikat['tgl_mulai']))}} </td>
                            </tr>
                            <tr>
                                <td>3.13.</td>
                                <td>Date of Analysis/ Tanggal Uji</td>
                                <td>: </td>
                                <td>{{$sertifikat['tgl_input'] == null ? '-' : date('d F Y', strtotime($sertifikat['tgl_input'])) }}</td>
                            </tr>
                            <tr>
                                <td>3.14.</td>
                                <td>Type of Analysis/ Jenis Uji</td>
                                <td>: </td>
                                <td> Terlampir</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><br> Next page 3 / Halaman selanjutnya 3</td>
                            </tr>
                            </table>
                        </div>
                    </div>
            ...
            <div>
                {{-- content manual --}}
                    <div style="margin:20px 30px 0 36px;">
